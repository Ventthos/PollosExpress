...
"}")
        ...
        self.GridDatos.addWidget(self.LabelTipoPromocion, 0, 1, 1, 1)
...
"}")
        ...
        self.GridDatos.addWidget(self.LabelFechaFinal, 2, 1, 1, 1)
...
"}")
        ...
        self.GridPromociones.addLayout(self.gridPromocionesDatos, 3, 0, 1, 1)
...
"}")
        ...
        self.GridPromociones.addLayout(self.GridBotonesAgregarQuitar, 5, 0, 1, 1)
