...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 238, 398))
        ...
        self.GridPromociones.setContentsMargins(20, 20, 60, 10)
...
"}")
        ...
        self.GridPromociones.addLayout(self.gridLayout_3, 2, 0, 1, 1)
...
"}")
        ...
        self.GridPromociones.addWidget(self.textEdit, 1, 0, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        self.GridPromociones.addItem(spacerItem1, 3, 0, 1, 1)
